...
public final class EcoffEnumConverterUtil {
	 ...
	 */
	public static <T extends EcoffEnumConverter> DataType toDataType(T object) {
		return toDataType(object.getClass());
	}

    @SuppressWarnings({"unchecked", "rawtypes"})
	public static <T extends EcoffEnumConverter> DataType toDataType(Class<T> clazz) {
        int size = 0;
